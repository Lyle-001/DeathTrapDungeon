...
def get_monster_intel_talk():
    return ['May the best man win.',
            'En garde!',
...
def get_goblin_intel_talk():
    return [
            "I'm sorry, my family needs money.", 
...
def get_goblin_norm_talk():
    return [
            'Tee hee hee, you will never get my riches',
...
def get_vampire_intel_talk():
    return ["En guarde, warrior!", 
...
def get_slime_intel_talk():
    return ["Hey! Get a move on!", 
            "I'm boinging here!",
            ...
            "I'm gonna cover you in my special goo!"
        ]

def get_slime_norm_talk():
    return ['BOOOIIINNNGGG!!',
            "BOING!",
            "BOING BOING BOING!",
            "blub blurp",
            "blup bluuup",
...
def get_rogue_intel_talk():
    return [
            "While I am going to try and kill you, I'll make sure it doesn't hurt too much.", 
